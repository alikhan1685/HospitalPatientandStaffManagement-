...
public class MainMenu extends Application {
    ...
    public void start(Stage stage) {
        ...
        Label databaseDoctor = new Label("DATABASE");
        Label assignDoctor = new Label("ASSIGN");
        for (Label lbl : new Label[]{addDoctor, databaseDoctor, assignDoctor}) {
        ...
        doctorOptions.getChildren().addAll(addDoctor, databaseDoctor, assignDoctor);
        ...
        Label databaseNurse = new Label("DATABASE");
        Label assignNurse = new Label("ASSIGN");
        for (Label lbl : new Label[]{addNurse, databaseNurse, assignNurse}) {
            lbl.setStyle("-fx-text-fill: white; -fx-font-size: 10px; -fx-padding: 3 5 3 20; -fx-cursor: hand;");
            lbl.setOnMouseEntered(e -> lbl.setStyle("-fx-text-fill: #1abc9c; -fx-font-size: 10px; -fx-padding: 3 5 3 20; -fx-cursor: hand;"));
            lbl.setOnMouseExited(e -> lbl.setStyle("-fx-text-fill: white; -fx-font-size: 10px; -fx-padding: 3 5 3 20; -fx-cursor: hand;"));
        }
        nurseOptions.getChildren().addAll(addNurse, databaseNurse, assignNurse);
        ...
        Label databaseTechnician = new Label("DATABASE");
        Label assignTechnician = new Label("ASSIGN");
        for (Label lbl : new Label[]{addTechnician, databaseTechnician, assignTechnician}) {
            lbl.setStyle("-fx-text-fill: white; -fx-font-size: 10px; -fx-padding: 3 5 3 20; -fx-cursor: hand;");
            lbl.setOnMouseEntered(e -> lbl.setStyle("-fx-text-fill: #1abc9c; -fx-font-size: 10px; -fx-padding: 3 5 3 20; -fx-cursor: hand;"));
            lbl.setOnMouseExited(e -> lbl.setStyle("-fx-text-fill: white; -fx-font-size: 10px; -fx-padding: 3 5 3 20; -fx-cursor: hand;"));
        }
        technicianOptions.getChildren().addAll(addTechnician, databaseTechnician, assignTechnician);
       ...
       //     showContent(scheduleForm.getForm());
        ...
        databaseDoctor.setOnMouseClicked(e -> {
        ...
        databaseNurse.setOnMouseClicked(e -> {
            DatabaseOfNurseForm availableNurses = new DatabaseOfNurseForm();
        ...
        databaseTechnician.setOnMouseClicked(e -> {
        	DataBaseOfTechnicianForm databaseTechnicians = new DataBaseOfTechnicianForm();
            showContent(databaseTechnicians.getForm());
        });
